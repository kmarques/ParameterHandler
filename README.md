...
[![Build Status](https://travis-ci.org/kmarques/ParameterHandler.png)](https://travis-ci.org/kmarques/ParameterHandler)
[![Latest Stable Version](https://poser.pugx.org/kmarques/composer-parameter-handler/v/stable.png)](https://packagist.org/packages/kmarques/composer-parameter-handler)
[![Latest Unstable Version](https://poser.pugx.org/kmarques/composer-parameter-handler/v/unstable.png)](https://packagist.org/packages/kmarques/composer-parameter-handler)
